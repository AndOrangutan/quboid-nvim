...
util.keymap('n', '<leader>xt', '<cmd>TodoTrouble<cr>', 'Trouble E[x]plore [t]odo Comments')
util.keymap('n', ']t', function () require("todo-comments").jump_next() end, 'Next Todo Comment')
util.keymap('n', '[t', function () require("todo-comments").jump_prev() end, 'Prev Todo Comment')
