...
--- Configuration to pass into setup{on_attach} function
---@param client client client argument passed into the setup.on_attach
---@param bufnr bufnr bufnr argument passe dinto the setup.on_attach
M.on_attach = function (client, bufnr)
    vim.api.nvim_buf_set_option(bufnr, 'omnifunc', 'v:lua.vim.lsp.omnifunc')

    -- configure lsp_signature here so that toggle works.
...
---@param extend_on_attach nil|function function that is passed into on_attach
